# [Django & Plotly](https://github.com/app-generator/sample-django-plotly) `Sample`
...
- 👉 [Django Material Dashboard](https://appseed.us/product/material-dashboard/django/) - original `Product page`
...
- 🚀 **Plotly Page**: `http://localhost:8000/charts/index`
...
![[Django & Plotly - Open-source sample by AppSeed](https://user-images.githubusercontent.com/51070104/234290533-0a825c20-7410-41d6-bbd4-f29e17758ecd.png)
...
```bash
$ git clone https://github.com/app-generator/sample-django-plotly.git
$ cd sample-django-plotly
```
...
---
[Django & Plotly](https://github.com/app-generator/sample-django-plotly) `Sample`- Minimal **Django** core provided by **[AppSeed](https://appseed.us/)**
